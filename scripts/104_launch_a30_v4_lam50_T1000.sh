#!/usr/bin/env bash
# Launch five alpha=30, v=4, lambda=50 trajectories through T=1000.
set -u
cd /home/linyuliu/jxmount/diffusion_custom

OUT=outputs/cmts_a30_v4_lam50_bbright_d16_B8_T1000
...
mkdir -p "$OUT"
echo "=== launch a30_v4_lam50: T1000, five trajectories ==="
launch 0 0 2 60
launch 1 2 3 61
launch 2 3 4 62
launch 3 4 5 63
