#!/usr/bin/env bash
# Resume the five alpha=20, v=2, lambda=50 trajectories at t=200 and extend
# them through t=999. Existing checkpoints make this a paired continuation.
set -u
cd /home/linyuliu/jxmount/diffusion_custom

OUT=outputs/cmts_a20_v2_lam50_bbright_d16_B8_T200_0621_0437
...
echo "=== extend a20_v2_lam50: T200 -> T1000, five paired trajectories ==="
launch 0 0 2 40
launch 1 2 3 41
launch 2 3 4 42
launch 3 4 5 43
